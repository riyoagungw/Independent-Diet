...
if (!(isset($_SESSION['username']))) {
    header("location:index-quis.php");
} else {
    $name     = $_SESSION['name'];
...
if (@$_GET['q'] == 2)
    echo 'class="active"';
?>><a href="account.php?q=2"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span>&nbsp;Riwayat Quiziz</a></li>
    <li <?php
if (@$_GET['q'] == 3)
    echo 'class="active"';
?>><a href="account.php?q=3"><span class="glyphicon glyphicon-stats" aria-hidden="true"></span>&nbsp;Peringkat</a></li></ul>
...
<tr><td style="vertical-align:middle"><b>S.N.</b></td><td style="vertical-align:middle"><b>Nama</b></td><td style="vertical-align:middle"><b>Total Pertanyaan</b></td><td style="vertical-align:middle"><b>Jawaban Benar</b></td><td style="vertical-align:middle"><b>Jawaban Salah</b></td><td style="vertical-align:middle"><b>Total Poin</b></td><td style="vertical-align:middle"><b>Batas Waktu</b></td><td style="vertical-align:middle"><b>Action</b></td></tr>';
    $c = 1;
  ...
  <td style="vertical-align:middle"><b><a href="account.php?q=quiz&step=2&eid=' . $eid . '&n=1&t=' . $total . '&start=start" class="btn" style="margin:0px;background:darkorange;color:white">&nbsp;<span class="title1"><b>Continue</b></span></a></b></td></tr>';
                ...
                echo '<tr style="color:darkgreen"><td style="vertical-align:middle">' . $c++ . '</td><td style="vertical-align:middle">' . $title . '&nbsp;<span title="This quiz is already solve by you" class="glyphicon glyphicon-ok" aria-hidden="true"></span></td><td style="vertical-align:middle">' . $total . '</td><td style="vertical-align:middle">+' . $correct . '</td><td style="vertical-align:middle">-' . $wrong . '</td><td style="vertical-align:middle">' . $correct * $total . '</td><td style="vertical-align:middle">' . $time . '&nbsp;min</td>
  <td style="vertical-align:middle"><b><a href="account.php?q=result&eid=' . $eid . '" class="btn" style="margin:0px;background:darkred;color:white">&nbsp;<span class="title1"><b>Lihat Hasil</b></span></a></b></td></tr>';
            }
        }
    }
    $c = 0;
    echo '</table></div><div class="panel" style="padding-top:1px;padding-left:15%;padding-right:15%;word-wrap:break-word"><h3 align="center" style="font-family:calibri">==== Panduan Pengerjaan ====</h3><br /><ul type="circle"><font style="font-size:14px;font-family:calibri">';
...
function end(){
  data = prompt("Apakah Anda yakin untuk mengakhiri Kuis ini? Ingat, setelah selesai, Anda tidak dapat melanjutkan lagi dan hasil akhir akan ditampilkan. Jika Anda ingin melanjutkan, masukkan \\"SELESAI\\" di kotak teks di bawah ini dan tekan enter");
  if(data=="SELESAI"){
...
var countdownTimer = setInterval(\'secondPassed()\', 1000);
            ...
            echo '<font size="3" style="margin-left:100px;font-family:\'typo\' font-size:20px; font-weight:bold;color:darkred">Waktu tersisa : </font><span class="timer btn btn-default" style="margin-left:20px;"><font style="font-family:\'typo\';font-size:20px;font-weight:bold;color:darkblue" id="countdown"></font></span><span class="timer btn btn-primary" style="margin-left:50px" onclick="end()"><span class=" glyphicon glyphicon-off"></span>&nbsp;&nbsp;<font style="font-size:12px;font-weight:bold">Menyelesaikan Quiz</font></span>';
            $eid   = @$_GET['eid'];
            $sn    = @$_GET['n'];
            $total = @$_GET['t'];
...
<br />';
            ...
            if ($_GET["t"] > $_GET["n"] && $_GET["n"] != 1) {
                ...
                echo '<br /><a href="account.php?q=quiz&step=2&eid=' . $eid . '&n=' . ($sn - 1) . '&t=' . $total . '" class="btn btn-primary" style="height:30px"><span class="glyphicon glyphicon-arrow-left" aria-hidden="true"  style="font-size:12px"></span></a>&nbsp;&nbsp;&nbsp;&nbsp;<button type="submit" class="btn btn-default" disabled="true" id="sbutton" style="height:30px"><span class="glyphicon glyphicon-lock" style="font-size:12px" aria-hidden="true"></span><font style="font-size:12px;font-weight:bold"> Kunci</font></button>&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" class="btn btn-default" onclick="frmreset()" style="height:30px"></span><font style="font-size:12px;font-weight:bold">Reset</font></button>&nbsp;&nbsp;&nbsp;&nbsp;</form><br><br>';
...
<center><h1 class="title" style="color:#660033">Hasil</h1><center><br /><table class="table table-striped title1" style="font-size:20px;font-weight:1000;">';
        echo '<tr style="color:darkblue"><td style="vertical-align:middle">Jumlah Pertanyaan</td><td style="vertical-align:middle">' . $total . '</td></tr>
    ...
    <tr style="color:orange"><td style="vertical-align:middle">Tidak Terjawab&nbsp;<span class="glyphicon glyphicon-ban-arrow" aria-hidden="true"></span></td><td style="vertical-align:middle">' . ($total - $r - $w) . '</td></tr>
    <tr style="color:darkblue"><td style="vertical-align:middle">Skor&nbsp;<span class="glyphicon glyphicon-star" aria-hidden="true"></span></td><td style="vertical-align:middle">' . $s . '</td></tr>';
        $q = mysqli_query($con, "SELECT * FROM rank WHERE  username='$username' ") or die('Error157');
        while ($row = mysqli_fetch_array($q)) {
            $s = $row['score'];
            echo '<tr style="color:#990000"><td style="vertical-align:middle">Skor Keseluruhan&nbsp;<span class="glyphicon glyphicon-stats" aria-hidden="true"></span></td><td style="vertical-align:middle">' . $s . '</td></tr>';
        }
        echo '<tr></tr></table></div><div class="panel"><br /><h3 align="center" style="font-family:calibri">==== Rincian Analisis ====</h3><br /><ol style="font-size:20px;font-weight:bold;font-family:calibri;margin-top:20px">';
        ...
        while ($row = mysqli_fetch_array($q)) {
            ...
            if ($correctans == $ans && $ans != "Unanswered") {
                ...
                echo '<font style="font-size:14px;color:darkgreen"><b>Jawaban anda : </b></font><font style="font-size:14px;">' . $ans . '</font><br />';
...
<tr><td style="vertical-align:middle"><b>S.N.</b></td><td style="vertical-align:middle"><b>Quiz</b></td><td style="vertical-align:middle"><b>Total Pertanyaan</b></td><td style="vertical-align:middle"><b>Benar</b></td><td style="vertical-align:middle"><b>Salah<b></td><td style="vertical-align:middle"><b>Belum Dicoba<b></td><td style="vertical-align:middle"><b>Skor</b></td><td style="vertical-align:middle"><b>Action<b></td></tr>';
    $c = 0;
    while ($row = mysqli_fetch_array($q)) {
        $eid = $row['eid'];
        $s   = $row['score'];
...
if (@$_GET['q'] == 3) {
    ...
    echo '<div class="panel title">
<table class="table table-striped title1" >
<tr><td style="vertical-align:middle"><b>Rank</b></td><td style="vertical-align:middle"><b>Nama</b></td><td style="vertical-align:middle"><b>Cabang</b></td><td style="vertical-align:middle"><b>Nama Pengguna</b></td><td style="vertical-align:middle"><b>Skor</b></td></tr>';
    $c = $showfrom-1;
...
<a href="#" data-toggle="modal" data-target="#developers" s style="color:lightyellow;" onmouseover="this.style('color:yellow')" target="new">Diselenggarakan oleh InDiet Website 2021</a>
</div>
