...
<body>
  <div class="header">
    <div class="row">
      <div class="col-lg-6">
        <span class="logo">Quiz InDiet</span>
      </div>
        ...
        <form class="form-horizontal" name="form" action="sign.php?q=account.php" onSubmit="return validateForm()" method="POST">
          <fieldset>
            ...
            <div class="form-group">
              <label class="col-md-12 control-label" for="name"></label>
              <div class="col-md-12">
                <input id="name" name="name" placeholder="Masukkan Nama Lengkap" class="form-control input-md" type="text" value="<?php
                                                                                                                                  if (isset($_GET['name'])) {
                                                                                                                                    echo $_GET['name'];
                                                                                                                                  } ?>">
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                <input id="rollno" name="rollno" placeholder="Masukkan NIK (Ex.732116104***)" class="form-control input-md" type="text" value="<?php
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                <select id="gender" name="gender" placeholder="Jenis Kelamin" class="form-control input-md">
                  <option value="" <?php
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                <select id="branch" name="branch" placeholder="Pilih Cabang" class="form-control input-md">
                  <option value="" <?php
                  ...
                  <option value="BG" <?php
                                      ...
                                      ?>>Mengecilkan Paha</option>
                  <option value="MP" <?php
                                      if (isset($_GET['branch'])) {
                                        if ($_GET['branch'] == "MP")
                                          echo "selected";
                                      }
                                      ?>>Membakar kalori/lemak pada perut</option>
                  <option value="MK-LP" <?php
                                        if (isset($_GET['branch'])) {
                                          if ($_GET['branch'] == "MK-LP")
                                            echo "selected";
                                        }
                                        ?>>Membentuk Otot Dada</option>
                  <option value="MOD" <?php
                                      if (isset($_GET['branch'])) {
                                        if ($_GET['branch'] == "MOD")
                                          echo "selected";
                                      }
                                      ?>>Membentuk Berat Badan Ideal</option>
                  <option value="MBBI" <?php
                                        if (isset($_GET['branch'])) {
                                          if ($_GET['branch'] == "MBBI")
                                            echo "selected";
                                        }
  ...
  <option value="IMSC" <?php
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                <input id="username" name="username" placeholder="Masukkan Nama Pengguna" class="form-control input-md" type="username" value="<?php
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                <input id="phno" name="phno" placeholder="Masukkan No. HP" class="form-control input-md" type="number" value="<?php
                                                                                                                              if (isset($_GET['phno'])) {
                                                                                                                                echo $_GET['phno'];
                                                                                                                              }
                                                                                                                              ?>">
            ...
            <div class="form-group">
              ...
              <div class="col-md-12" style="text-align: center">
                <input type="submit" value=" Daftar Sekarang " class="btn btn-primary" style="text-align:center" />
              </div>
            </div>
  ...
  <div class="row footer">
    <div class="col-md-3 box">
      <a href="#" data-toggle="modal" data-target="#login" style="color:lightyellow">Server Login</a>
    </div>
    <div class="col-md-3 box">
      <span href="#" data-target="#login" style="color:lightyellow">Diselenggarakan oleh InDiet Website 2021 <br><br></span>
    </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title"><span style="color:darkblue;font-size:12px;font-weight: bold">Login ke akun server</span></h4>
          </div>
          <div class="modal-body title1">
            <div class="row">
              <div class="col-md-3"></div>
              <div class="col-md-6">
                <form role="form" method="post" action="admin.php?q=index-quis.php">
                  <div class="form-group">
                    <input type="text" name="uname" maxlength="20" placeholder="Masukkan Nama Pengguna" class="form-control" />
                  </div>
                  <div class="form-group">
                    <input type="password" name="password" maxlength="30" placeholder="Masukkan kata Sandi" class="form-control" />
                  </div>
